defmodule Pooly.PoolServer do
  ...
  defmodule State do
    defstruct pool_sup: nil, worker_sup: nil, monitors: nil, size: nil, workers: nil, mfa: nil, name: nil, overflow: nil, max_overflow: nil, waiting: nil
  end
